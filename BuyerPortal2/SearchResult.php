...
<nav class="navbar navbar-expand-xl ">
     ...
     <div class="container" style="color: #000000">
          <div class="d-flex justify-content-around mb-3" style="color: #000000">
               ...
               <div class="row   p-2">
                    <div class="col-12 col-xl-3 col-lg-3 col-md-12 col-sm-12">
                         <div class="text-center">
                              <h4 class="font-weight-bold" style="color: #000000">Select your region</h4>
                         </div>
                    </div>
     ...
     <div class="container ">
          ...
          <div class="row">
           ...
           ";
                         ...
                         echo "<h1 style='margin:150px auto;font-size:50px;text-wrap: nowrap;'>Product Not Available</h1>";
                    }
               }
               ?>
          </div>

               ...
               <div class="row   p-2">
                    <div class="col-12 col-xl-3 col-lg-3 col-md-12 col-sm-12">
                         <div class="text-center">
                              ...
                              " style="color: #000000;">Select your region</h4>
                         </div>
                    </div>
                    <div class="col-6 col-xl-3 col-lg-3 col-md-6 col-sm-6 p-0 States">

                    <select class="p-2 shadow-lg" id="states" name="stateInput" onchange="state()" tabindex="1" style="border-radius: 6px; margin-right:  200px; border:2px solid black;">
               ...
               if (isset($_GET['type'])) {
                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:500px;border:3px solid black;'>
                    ...
                    <div class='card-body pb-0'>
                        ...
                        <p class='card-text mb-2 font-weight-bold'>Price $product_price ₹/KG</p>
                        <div class='row'>
                            <div class='col-1 col-xl-3 col-lg-2 col-md-2 col-sm-2'></div>
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6  col-sm-12'>
                              <button class='btn btn-warning border-secondary mr-1 ' name='cart' type = 'submit' style='color:#f9b84d;background-color:black;marfin-top:50px;font-weight:50px;'>Add to cart</button>
                            </div>
                        </div>
                    </div>
                       </form>

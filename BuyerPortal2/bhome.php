...
<body style="background-color: #FFFF84;">
    ...
    <nav class="navbar navbar-expand-xl ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists" style="color:#ffff84">
                ...
                if (isset($_SESSION['phonenumber'])) {
                    ...
                    echo "<a href='../auth/BuyerLogin.php' class='list-group-item list-group-item-action ' style='background-color:#ffff84;color#ffff84;text-align:center;color:goldenrod'>Login</a>";
                }
                ?>
        ...
        <div class=" flex-row-reverse right ">
            ...
            <div class="text-success  login" style="color:#ffff84">Login</div>
        </div>

    </nav>


    <div class="container" style="background-color:#ffff84;width:100%;" >
        <div class="xyz" >

            <div class="p-2" >
                <div class="dropdown">
                    <button class="btn btn-black mybtn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Fruits
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <?php
...
<!-- 
    <div class="container"> <img src="b4.jpeg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image" style=" max-width: 750px; height: auto;">
    </div> -->
    <br>
    <br>

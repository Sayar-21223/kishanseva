...
<body style="background-color: #ffff84;">
    <nav class="navbar navbar-expand-xl ">
     ...
     <a style="position:absolute;left:50%;bottom:20px;color:#f9b84d;background-color:black;border-radius:6px;" href="InsertProduct.php"><button style="border-radius:6px;padding:4px;color:#f9b84d;background-color:black;">Add New Product</button></a>      
</html>